...
specs = {
    ...
    'Bulgaria': {
        'include': ['ITN', 'GERB', 'BSPzB', 'DB', 'DPS', 'IBG-NI', 'IMRO', 'BP', 'Revival', 'PP'],
        'key': ['firm', 'date', 'sample',
                'ITN', 'GERB', 'BSPzB', 'DB', 'DPS', 'IBG-NI', 'IMRO', 'BP', 'Revival', 'PP',
                'Other', 'lead', 'end'],
    ...
    'Romania': {
        'key': ['date', 'source', 'sample',
                ...
                'Other', 'lead', 'end'],
        'include': ['PSD', 'PNL', 'USR', 'AUR', 'UDMR', 'PMP', 'PRO', 'ALDE', 'PPU-SL', 'PER'],
        ...
        'start': -1,
        'url': 'https://en.wikipedia.org/w/index.php?title='
               'Next_Romanian_legislative_election&action=edit&section=9',
    },
    'Russia': {
