...
specs = {
    ...
    'Estonia': {
        ...
        'gov': [Period([Group('Kallas II Cabinet', ['Reform', 'Isamaa', 'SDE'])],
                       Date(2022, 7, 18)),
                Period([Group('Kallas I Cabinet', ['Reform', 'Centre'])],
                       Date(2021, 1, 26), Date(2022, 6, 3)),
                Period([Group('Ratas II Cabinet', ['Centre', 'EKRE', 'Isamaa'])],
                       Date(2019, 4, 29), Date(2021, 1, 14)),
                Period([Group('Ratas I Cabinet', ['Centre', 'SDE', 'Isamaa'])],
    ...
    'Germany': {
        ...
        'blocs': {'Left': ['SPD', 'Grüne', 'Linke'],
                  'Right': ['Union', 'FDP'],
                  'Nationalist': ['AfD']},
        'gov': [Period([Group('Scholz Cabinet', ['SPD', 'Grüne', 'FDP'])], Date(2021, 12, 8)),
                Period([Group('Merkel IV Cabinet', ['Union', 'SPD'])], Date(2018, 3, 14), Date(2021, 12, 8))],
        'start': 0,
    ...
    'Italy': {
        ...
        'gov': [
            Period([Group('Meloni Cabinet', ['FdI', 'Lega', 'FI', 'NM'])], Date(2022, 10, 22)),
            Period([Group('Draghi Cabinet', ['M5S', 'Lega', 'PD', 'FI', 'IpF', 'IV', 'Art.1', 'A', 'CD', 'NcI', '+Eu',
                                             '+E', '+E-A', 'A-IV'])],
                   Date(2021, 2, 13), Date(2022, 10, 22)),
            Period([Group('Conte II Cabinet', ['M5S', 'PD', 'Art.1', 'IV', 'SI', 'LeU'])],
                   Date(2019, 9, 5), Date(2021, 2, 13)),
            Period([Group('Conte I Cabinet', ['M5S', 'Lega'])],
                   Date(2018, 6, 1), Date(2019, 9, 5)),
            Period([Group('Gentiloni Cabinet', ['PD'])],
    ...
    'Sweden': {
        ...
        'gov': [Period([Group('Kristersson Cabinet', ['M', 'L', 'KD']),
                        Group('Kristersson Support', ['SD']),
                        Group('Kristersson Cabinet & Support', ['M', 'L', 'KD', 'SD']),
                        Group('Kristersson Opposition', ['S', 'V', 'MP', 'C'])],
                       Date(2022, 10, 18)),
                Period([Group('Andersson Cabinet', ['S']),
                        Group('Andersson Support', ['V', 'MP', 'C']),
                        Group('Andersson Cabinet & Support', ['S', 'V', 'MP', 'C']),
                        Group('Andersson Opposition', ['M', 'SD', 'L', 'KD'])],
                       Date(2021, 11, 30), Date(2022, 10, 18)),
                Period([Group('Löfven III Cabinet', ['S', 'MP']),
                        Group('Löfven III Support', ['C', 'V']),
                        Group('Löfven III Cabinet & Support', ['S', 'C', 'V', 'MP']),
                        Group('Löfven III Opposition', ['M', 'SD', 'KD', 'L'])],
                       Date(2021, 7, 9), Date(2021, 11, 30)),
                Period([Group('Löfven II Cabinet', ['S', 'MP']),
                        Group('Löfven II Support', ['C', 'L']),
                        Group('Löfven II Cabinet & Support', ['S', 'C', 'L', 'MP']),
                        Group('Löfven II Opposition', ['M', 'SD', 'KD', 'V'])],
                       Date(2019, 1, 21), Date(2021, 7, 9)),
                Period([Group('Löfven I Cabinet', ['S', 'MP']),
                        Group('Löfven I Support', ['V']),
                        Group('Löfven I Cabinet & Support', ['S', 'V', 'MP']),
                        Group('Löfven I Opposition', ['M', 'SD', 'L', 'KD', 'C'])],
                       Date(2014, 10, 3), Date(2019, 1, 21))],
        'start': 0,
        'restart': ['http'],
